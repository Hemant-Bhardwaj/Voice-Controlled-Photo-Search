...
apigClientFactory.newClient = function (config) {
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        console.log("searchGet - params: ", params);
        console.log("searchGet - body: ", body);
        console.log("searchGet - additionalParams: ", additionalParams);
        
        utils.assertParametersDefined(params, ['q'], ['body']);

        console.log("searchGet function: ", utils.assertParametersDefined(params, ['q'], ['body']))
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        console.log('uploadBucketKeyPut params: ', params)
        
        utils.assertParametersDefined(params, ['key', 'bucket'], ['body']);

        console.log('uploadBucketKeyPut utils.assertParametersDefined: ', utils.assertParametersDefined(params, ['key', 'bucket'], ['body']))
