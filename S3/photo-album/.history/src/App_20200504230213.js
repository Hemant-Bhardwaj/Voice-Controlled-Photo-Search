...
const audioProps = {
  ...
  return (
    ...
    <div className={classes.grow}>
      ...
      <IconButton className={classes.icons} aria-label="search" onClick={controlAudio("recording")}>
        <MicIcon />
      </IconButton>
      </Tooltip>
      <Tooltip title = "Stop recording">
      <IconButton className={classes.icons} aria-label="search" onClick={controlAudio("inactive")}>
      <MicOffIcon />
      </IconButton>
      </Tooltip>
      </AudioAnalyser>
